...
class Employee {
  ...
  Employee copyWith({
    ...
    List<Task>? tasks,
    List<LeaveRequest>? leaveRequests,
    bool? isActive, // Add isActive to copyWith
  }) {
    return Employee(
      name: name ?? this.name,
      role: role ?? this.role,
      ...
      isActive: isActive ?? this.isActive, // Copy isActive value
    );
  }
}
...
class _EmployeeScreenState extends State<EmployeeScreen> {
  List<Employee> employees = [
    Employee(
      ...
      isActive: true, // John Doe is active
    ),
    Employee(
      name: "Jane Smith",
      role: "UI/UX Designer",
      ...
      isActive: false, // Jane Smith is inactive
    ),
    Employee(
      name: "Michael Brown",
      role: "HR Manager",
      ...
      isActive: true, // Michael Brown is active
    ),
    Employee(
      name: "Alice Johnson",
      ...
      isActive: true, // Alice Johnson is active
    ),
  ];
    ...
    final newEmployee = await Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => EmployeeEditScreen(
            employee: null, isNew: true, onDelete: null),
      ),
    );
  ...
  void _editEmployee(BuildContext context, Employee employee, int index,
      Function() onDelete) async {
    final updatedEmployee = await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => EmployeeEditScreen(
            employee: employee, isNew: false, onDelete: onDelete),
      ),
    );
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => EmployeeProfileScreen(
                            employee: employee,
                            onEmployeeUpdated: (Employee updatedEmployee) {
                              setState(() {
                                employees[index] = updatedEmployee;
                                filteredEmployees = employees;
                              });
...
class _EmployeeProfileScreenState extends State<EmployeeProfileScreen> {
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  subtitle: Text('Due Date: ${DateFormat('yyyy-MM-dd').format(task.dueDate.toLocal())}'), // Format the date
                  trailing: Checkbox(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 10),
                Text('Start Date: ${DateFormat('yyyy-MM-dd').format(request.startDate.toLocal())}'), // Format the date
                Text('End Date: ${DateFormat('yyyy-MM-dd').format(request.endDate.toLocal())}'), // Format the date
  ...
  Widget _buildAttendanceView() {
    ...
    final List<Map<String, String>> attendanceData = [
      {"Date": "2025-03-01", "Check In": "09:00 AM", "Check Out": "05:00 PM", "Status": "Present"},
      {"Date": "2025-03-02", "Check In": "09:05 AM", "Check Out": "05:02 PM", "Status": "Present"},
      {"Date": "2025-03-03", "Check In": "08:58 AM", "Check Out": "05:01 PM", "Status": "Present"},
      {"Date": "2025-03-04", "Check In": "-", "Check Out": "-", "Status": "Absent"},
    ];
    ...
    return Scaffold(
      ...
      body: IndexedStack(
        ...
        children: [
          ...
          _buildTaskListView(),
          _buildLeaveView(),
          _buildAttendanceView(), // Add the attendance view
        ],
      ),
      bottomNavigationBar: BottomNavigationBar(
        items: const <BottomNavigationBarItem>[
          ...
          BottomNavigationBarItem(
            icon: Icon(Icons.access_time), // Added attendance icon
            label: 'Attendance', // Added attendance label
          ),
        ],
        ...
        child: Form(
          ...
          child: ListView(
            children: <Widget>[
              ...
              ListTile(
                title: Text("Due Date: ${DateFormat('yyyy-MM-dd').format(dueDate.toLocal())}"), // Format the date
...
class _EmployeeEditScreenState extends State<EmployeeEditScreen> {
  ...
  late bool isActive; // Add isActive state
  ...
  void initState() {
    ...
    isActive = widget.employee?.isActive ?? true; // Initialize isActive
  }
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              SwitchListTile( // Add switch for isActive
                title: Text('Active'),
                value: isActive,
                ...
                onPressed: () {
                  if (_formKey.currentState!.validate()) {
                    final newEmployee = Employee(
                      ...
                      isActive: isActive, // Save isActive value
                    );
